...
[ -f "$AIOS_ROOT/kernel/linux/arch/x86/boot/bzImage" ] && cp "$AIOS_ROOT/kernel/linux/arch/x86/boot/bzImage" "$ISO_ROOT/boot/vmlinuz" || { echo "Error: Kernel image missing"; exit 1; }
